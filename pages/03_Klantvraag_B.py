    ...
    with st.container(border = True):
        ...
        with st.expander('**3.1 Klantkeuze voor duurzaam**'):
            ...
            if ss.klanttype_value == 'B2B':
                ...
                st.write('**Belang van duurzaamheid bij meubels.** Op de vraag "Hoe belangrijk is duurzaamheid voor jou bij het kiezen van meubels?" reageert de meerderheid positief. Slechts 16% acht het onbelangrijk.')
